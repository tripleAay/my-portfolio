...
const About = () => {
  ...
  digital solutions. I hold an <span className="font-semibold text-yellow-500">Hnd and a BSc degree in Computer Science</span>, 
...
<p className={`transition-all duration-300 ease-in-out text-lg leading-relaxed mb-6 ${lightMode? "":"text-gray-800"}`}>
  ...
  <span className="italic text-yellow-500">creativity, functionality, and strategy</span> to help brands 
...
<ul className={`transition-all duration-300 ease-in-out list-disc list-inside mb-6 space-y-2 ${lightMode? "":"text-gray-800"}`}>
  <li>
    Cutting-edge <span className="text-yellow-500">web development</span> that delivers seamless user experiences.
  </li>
  <li>
    Purpose-driven <span className="text-yellow-500">brand design</span>, from logos to complete visual identities.
  </li>
...
<p className={`transition-all duration-300 ease-in-out text-lg leading-relaxed mb-6 ${lightMode? "":"text-gray-800"}`}>
  ...
  <span className="italic text-yellow-500">game-changing ideas</span> to empower others. My work is not just my craft; 
  it’s my passion.
</p>
