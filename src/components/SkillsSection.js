...
const SkillsSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-gray-900 px-6">
        <h2 className="text-4xl font-bold text-white mb-6 text-center hover:underline hover:text-yellow-500 transition duration-300">My Skills</h2>
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-10 items-center justify-center">
      ...
      {skills.map((skill, index) => (
        <div
          key={index}
          className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 shadow-lg transform hover:scale-105 transition duration-300"
        >
